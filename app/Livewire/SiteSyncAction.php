...
class SiteSyncAction extends Component implements HasActions, HasSchemas
{
    ...
    {
        return Action::make('syncSite')
            ->label('Sync Site')
            ->tooltip('Sync data between two environments of the selected site.')
    ...
    {
        return view('livewire.site-sync-action');
    }
}
